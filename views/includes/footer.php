...
<!-- <a href="https://here-law.channel.io/home" target="_blank" class="fixBtn fixKakaoBtn"><img src="/assets/img/common/fixKakaoBtn.svg" alt="영웅 카카오톡 채널 바로가기"></a> -->
<button class="fixBtn fixUpBtn"><img src="/assets/img/common/fixUpBtn.svg" alt="화면 맨 위로 이동"></button>
<a href="tel:1666-6087" class="fixBtn fixCallBtn"><img src="/assets/img/common/fixCallBtn.svg" alt="1666-6087"></a>
    ...
    <article class="popupContentArti">
      ...
      <div class="contentBox">
        <div class="contentBoxInner">
          법률사무소 영웅(사이트 주소/이하 ‘회사’) 은(는) 개인정보 보호법 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립·공개합니다. <br /><br />
          ...
          성명 : 백상희<br />
          직책 : 대표<br />
          연락처 : <전화번호>010-8000-6240, <이메일>kikak_2000@hanmail.net, <팩스번호>02)6915-8057<br />
          ※ 개인정보 보호 담당부서로 연결됩니다.<br /><br />

          ▶ 개인정보 보호 담당부서<br />
          부서명 : 마케팅부서<br />
          담당자 : 백상희<br />
          연락처 : <전화번호>010-8000-6240, <이메일>bsh@in-consulting.co.kr, <팩스번호>02)6915-8057<br /><br />
          ...
          이 개인정보 처리방침은 2024년. 8월 n일부터 적용됩니다.
        </div>
      </div>
    </article>
  </div>
...
<footer>
  <div class="ft_pc">
    <div class="inner">
      <div class="logoWrap">
        <img src="/assets/img/common/footer_logo.png" alt="법률사무소 영웅, LAWFIRM HERO" class="logo" />
        <div class="responsibilityDiv">
          <div class="contentBox">
            <div class="title">대표변호사</div>
            <div class="content">박진우</div>
          </div>
          <div class="contentBox">
            <div class="title">광고책임변호사</div>
            <div class="content">박진우</div>
          </div>
        </div>
        <div class="copyRightBox">
          Copyright ⓒ 2024 법률사무소 영웅. All rights reserved.
        </div>
      </div>
      <div class="centerBox">
        <div class="contentBox">
          <div class="title">대표번호</div>
          <div class="content">1666-6087</div>
        </div>
        <div class="contentBox">
          <div class="title">주소</div>
          <div class="content">서울특별시 강남구 테헤란로 425 신일빌딩 9층</div>
        </div>
        <div class="contentBox">
          <div class="title">사업자 번호</div>
          <div class="content">225-33-01547</div>
        </div>
        <div class="halfBox">
          <div class="contentBox">
            <div class="title">FAX</div>
            <div class="content">02-6915-8057</div>
          </div>
          <div class="contentBox">
            <div class="title">E-mail</div>
            <div class="content">lawfirmhero@lawfirm-hero.com</div>
          </div>
        </div>
      </div>
      <div class="rightBox">
        <div class="menuList">
          <ul class="menu">
            <li><a href="/professional" class="">변호사소개</a></li>
            <li><a href="/cases">업무사례</a></li>
            <li><a href="/columns">칼럼</a></li>
            <li><a href="/news">언론보도</a></li>
            <li><a href="/counseling/visit" class="">상담신청</a></li>
          </ul>
        </div>
      ...
      <div class="rightBox">
        <div class="menuList">
          <ul class="menu">
            ...
            <li><a href="/news">언론보도</a></li>
            <li><a href="/cases">업무사례</a></li>
            <li><a href="/counseling/visit">상담신청</a></li>
            <li><a href="/columns">칼럼</a></li>
          </ul>
        </div>
        <div class="popupBtnBox">
