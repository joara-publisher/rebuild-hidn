<!--변호사 소개 상세 섹션 시작 { -->
<style>
    .lawyerViewArti .imgBox { background-image: url('/assets/img/sub/lawyerArti/detail_img_0<?php echo $_GET["no"] ?>.jpg'); }
    
    @media (max-width: 576px) {
        .lawyerViewArti .imgBox { height: 111.50vw; background-image: url('/assets/img/sub/lawyerArti/detail_img_0<?php echo $_GET["no"] ?>_m.jpg'); }
    }
</style>
<div class="sub">
    <article class="lawyerViewArti ani">
        <div class="lawyerViewInner">
            <?php 
            if($_GET['no']==1){//김은정
            ?>
                <div class="imgBox">
                    <div class="boxInner">
                        ...
                        <div class="btnWrap">
                            <span>전문가소개 더보기</span>
                            <a class="btnPrev" href="/lawyer/view?no=3"></a>
                            <a class="btnNext" href="/lawyer/view?no=2"></a>
                        </div>
                    </div>
                </div>
                <div class="txtBox">
            ...
            ?>
                <div class="imgBox">
                    <div class="boxInner">
                        ...
                        <div class="btnWrap">
                            <span>전문가소개 더보기</span>
                            <a class="btnPrev" href="/lawyer/view?no=1"></a>
                            <a class="btnNext" href="/lawyer/view?no=3"></a>
                        </div>
                    </div>
                </div>
                <div class="txtBox">
            ...
            ?>
                <div class="imgBox">
                    <div class="boxInner">
                        ...
                        <div class="btnWrap">
                            <span>전문가소개 더보기</span>
                            <a class="btnPrev" href="/lawyer/view?no=2"></a>
                            <a class="btnNext" href="/lawyer/view?no=1"></a>
                        </div>
                    </div>
                </div>
                <div class="txtBox">
